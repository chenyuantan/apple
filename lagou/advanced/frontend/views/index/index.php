	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="<?=Url::toRoute(['index/company']) ?>" >公司</a></li>
    			<li ><a href="h/toForum.html" target="_blank">论坛</a></li>
    			<li ><a href="<?=Url::toRoute(['index/jian']) ?>" rel="nofollow">我的简历</a></li>
	    		<li ><a href="<?=Url::toRoute(['index/create']) ?>" rel="nofollow">发布职位</a></li>
	    	</ul>
        	            <ul class="loginTop">
            	<li><a href="<?=Url::toRoute(['login/index']) ?>" rel="nofollow">登录</a></li> 
            	<li>|</li>
            	<li><a href="<?=Url::toRoute(['login/register']) ?>" rel="nofollow">注册</a></li>
            </ul>
                                </div>
    </div><!-- end #header -->
    <div id="container">
		...
		<div id="sidebar">
			<div class="mainNavs">
				...
				<div class="menu_main">
				<?php foreach ($parm as $key => $value) {?>
					
				
					<h2><?=$value['category_name'] ?> <span></span></h2>
				<?php } ?>
