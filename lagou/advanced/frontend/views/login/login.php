...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
		   <!-- <h3><span style="color:red">拉钩欢迎您的到来</span></h3> -->
        	<form id="loginForm" action="<?=Url::toRoute(['login/login'])?>" method="post">
                ...
                <input type="submit" id="submitLogin" value="登 &nbsp; &nbsp; 陆" />
            ...
            <div class="login_right">
            	<div>还没有拉勾帐号</div>
            	<a  href="<?=Url::toRoute(['login/register'])?>"  class="registor_now">去注册</a><br/>
                <a  href="<?=Url::toRoute(['login/yong'])?>"  class="registor_now">忘记密码</a>
