var base_path = 'http://www.lagou.com/frontend/web/';
                ...
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var b = $('input[name="projectName"]', a).val(),
                            ...
                            s =$("#resid").val()
                            $.ajax({
                                url:base_path + "index.php?r=admin-user/undergo",
                                type: "POST",
                                data: {
                                    resid:s,
                                    projectName: b,
                                ...
                                if(b){
                                    alert('保存成功')
                                    var str =b['project_name']+"/"+b['project_position']
                                    $("#bac").html(str)
                                    $(".projectForm .btn_profile_cancel").trigger('click');
                                }
                            })
                    }
                })
                ...
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var b = "请输入作品链接" != $('input[name="workLink"]', a).val() ? $('input[name="workLink"]', a).val() : "",
                            ...
                            s = $("#resid").val();
                            $.ajax({
                                url:base_path + "index.php?r=admin-user/show",
                                type: "POST",
                                data: {
                                    resid:s,
                                    url: b,
                                ...
                                if(b){
                                    alert('保存成功')
                                    var str =b['projecturl']+"/"+b['projectstate']
                                    $("#npc").html(str)
                                    $(".workForm .btn_profile_cancel").trigger('click');
                                }
                            })
                    }
                })
            ...
            $("#profileForm").validate({
                ...
                submitHandler: function(a) {
                    var b = $('input[name="name"]', a).val(),
                        ...
                        $.ajax({
                            url:base_path + "index.php?r=admin-user/resume-manager",
                            type: "POST",
                            data: {
                                name: b,
                                sex: c,
                            ...
                            if(b){
                                alert('保存成功')
                                var str =b['real_name']+"/"+b['sex']+"/"+b['school_name']+"</br>"+b['phone']+"/"+b['email']+"</br>"
                                $("#ides").html(str)
                                $("#profileForm .btn_profile_cancel").trigger('click');
                            }
                        })
                }
            }),
            ...
            $("#expectForm").validate({
                ...
                submitHandler: function(a) {
                    var c = $('input[name="expectCity"]', a).val(),
                        ...
                        h = $("#resubmitToken").val();
                        $.ajax({
                            url:base_path + "index.php?r=admin-user/working",
                            type: "POST",
                            data: {
                                city: c,
                                positionType: d,
                            ...
                            if(g){
                                alert('保存成功')
                                $('#expectPosition').val(g.q_position)
                                $('#resid').val(g.id)
                                var str=g.q_city+"/"+g.q_position+"/<br>"+g.q_money
                                $("#span").html(str)
                                $("#expectForm .btn_profile_cancel").trigger('click');
                ...
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var b = $('input[name="companyName"]', a).val(),
                            ...
                            s = $("#resid").val()
                            $.ajax({
                                url:base_path + "index.php?r=admin-user/workexper",
                                type: "POST",
                                data: {
                                    resid:s,
                                    companyName: b,
                                ...
                                if(b){
                                    alert('保存成功')
                                    var str =b.old_company+"/"+b.old_position+"/<br>"+b.start_time+"/"+b.end_time
                                    $("#abc").html(str)
                                    $(".experienceForm .btn_profile_cancel").trigger('click');
                                }
                            })
                    }
                })
                ...
                $(this).validate({
                    ...
                    submitHandler: function(a) {
                        var b = $('input[name="schoolName"]', a).val(),
                            ...
                            s = $("#resid").val()
                            $.ajax({
                                url:base_path + "index.php?r=admin-user/setting",
                                type: "POST",
                                data: {
                                    resid: s,
                                    schoolName: b,
                               ...
                               if(b){
                                   alert('保存成功')
                                   var str =b.graduateshool+"/"+b.major
                                   $("#zxc").html(str)
                                   $(".educationalForm .btn_profile_cancel").trigger('click');
                               }
                            })
                    }
                })
            ...
            $(".descriptionForm").validate({
                ...
                submitHandler: function(a) {
                    var b = $('textarea[name="selfDescription"]', a).val(),
                        ...
                        s = $("#resid").val();
                        $.ajax({
                            url:base_path + "index.php?r=admin-user/describe",
                            type: "POST",
                            data: {
                                resid: s,
                                myRemark: b,
                            ...
                            if(b){
                                alert('保存成功')
                                var str =b.graduateshool
                                $("#pods").html(str)
                                $(".descriptionForm .btn_profile_cancel").trigger('click');
                            }
                        })
                }
            }),
